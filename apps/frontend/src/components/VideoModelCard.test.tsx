 ...
 */
const second = { id: "gen4_alt" as VideoModel, label: "다른 모델", pricePerSecondUsd: 0.12, ratios: ["720:1280"], minDurationSeconds: 2, maxDurationSeconds: 10, acceptsLastFrame: false, frameShape: "requested" as const };
