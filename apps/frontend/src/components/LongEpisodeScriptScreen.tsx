    ...
    <section className="mt-8 max-w-4xl space-y-5">
      ...
      {!hasScript && episode?.status === "outline_ready" && (
        <div className="space-y-3">
          {/* Long-form Episode scripts are assembled locally by design, not generated by an AI:
              EpisodeScriptsService takes only a projects root, with no provider or budget service injected —
              unlike the Episode image and video services next to it. The short project's story step does call
