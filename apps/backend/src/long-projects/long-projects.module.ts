...
@Module({ imports: [ProjectsModule, AssetsModule, ProviderSettingsModule, ProjectAssetMappingsModule], controllers: [LongProjectsController, StoryBibleController, EpisodeScriptsController, EpisodeAssetMappingsController, EpisodeAssetMappingsFlowController, EpisodeImagesController, EpisodeVideosController, EpisodeVideoMergeController, EpisodeContinuityController, EpisodeContinuityReferenceController, EpisodeTimelineController, EpisodeNarrationController], providers: [
  {
