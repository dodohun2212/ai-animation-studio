...
import { toEpisodeInstagramPost, toEpisodeUsedAudio } from "./episode-detail.js";
...
export class EpisodeScriptsService {
  ...
  async get(projectId: string, number: number): Promise<GetLongEpisodeResponse> {
    ...
    return { episode: { ...this.toApi(outline, stored), narrationAvailable } };
  }
